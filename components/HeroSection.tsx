...
// Define an interface for the FloatingCard props
            ...
            ">
                ...
                <div className="col-span-12 lg:col-span-5 relative h-[500px]">
                    <FloatingCard
                        ...
                        className="absolute top-10 right-0 lg:right-10 rotate-[-2deg]"
                    />
                    <FloatingCard
                        icon={<div className="w-6 h-6 border-2 border-tech-orange rounded" />}
                        stage="STAGE 02"
